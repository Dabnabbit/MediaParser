...
Provides fixtures for Phase 1 and Phase 2 testing.
"""
import os
import tempfile
...
# Minimal 1x1 JPEG (red pixel) — valid JPEG that imagehash can process
MINIMAL_JPEG = bytes([
...
def timestamped_file(temp_dir):
    """Create a JPEG file with timestamp in filename."""
    file_path = temp_dir / "IMG_20240115_120000.jpg"
    file_path.write_bytes(MINIMAL_JPEG)
    return file_path
